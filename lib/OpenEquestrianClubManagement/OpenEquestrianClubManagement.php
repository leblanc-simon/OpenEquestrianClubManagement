...
namespace OpenEquestrianClubManagement;
 ...
 * Application class
 *
 * @package     OpenEquestrianClubManagement
 * @version     1.0.0
 * @license     http://opensource.org/licenses/MIT  MIT
 * @author      Simon Leblanc <contact@leblanc-simon.eu>
 */
class OpenEquestrianClubManagement
{
    /**
    ...
    {   
        ...
        // Propel connection
        \Propel::init(Config::get('config_dir').DIRECTORY_SEPARATOR.'OpenEquestrianClubManagement-conf.php');
